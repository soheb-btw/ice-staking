...
const Highlights = () => {
    return (
        <div className="flex flex-col items-center justify-center gap-6 sm-lg:grid grid-cols-2 grid-rows-2-auto gap-x-3 sm-lg:gap-y-10">
            ...
            <Image src={"/assets/test.svg"} width={414} height={382} alt="logo" />
            <div className="flex flex-col gap-3 justify-between items-center">
                <Image src={"/assets/test2.svg"} width={414} height={240} alt="logo" />
                <Image src={"/assets/test3.svg"} width={414} height={130} alt="logo" />
            </div>
        </div>
    )
}
