...
const ResourceCard = ({ cardData }: { cardData: CardData }) => {
    ...
    return (
        <div className="w-[272px] bg-white rounded-2xl flex flex-col">
            <Image className="rounded-tl-2xl rounded-tr-2xl" src={imageUrl} width={272} height={279} alt={'resource card image'} />
...
export async function generateStaticParams() {
    return [{imageUrl: '/assets/resources-1.png'}, {imageUrl: '/assets/resources-2.png'}, {imageUrl: '/assets/resources-3.png'}, {imageUrl: '/assets/resources-4.png'}]
}
